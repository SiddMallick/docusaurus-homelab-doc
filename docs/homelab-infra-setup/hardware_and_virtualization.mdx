...
As depicted in the infrastructure/ architecture/ network diagram, the choice of hardware is minimal which suites the purpose of a beginner's homelab. RAM costs are shooting up and thats why devices are not cheap anymore - thus using refurbished products is the smartest move.
